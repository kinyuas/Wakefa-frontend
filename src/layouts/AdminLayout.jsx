// layouts/AdminLayout.jsx - UPDATED FOR 1-HOUR TIMEOUT
...
const AdminLayout = ({ children }) => {
  ...
  useEffect(() => {
    console.log('🔄 AdminLayout mounted - initializing activity tracking');
    ...
    const activityInterval = setInterval(async () => {
      try {
        ...
        if (!isValid) {
          ...
          navigate('/admin/login?expired=inactivity', { 
            replace: true 
          });
        }
      } catch (error) {
